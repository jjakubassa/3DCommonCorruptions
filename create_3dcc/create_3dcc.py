...
parser.add_argument(
    "--path_reshade", dest="path_reshade", help="path to reshade images"
)
parser.set_defaults(path_depth="NONE")

parser.add_argument(
    "--path_relighting", dest="path_relighting", help="path to lighting images"
)
parser.set_defaults(path_depth="NONE")

parser.add_argument(
    "--path_target", dest="path_target", help="path to store 3dcc generated images"
)
...
create_non3d_data(
    BASE_PATH_RGB=path_rgb, BASE_TARGET_PATH=path_target, BATCH_SIZE=batch_size
)
...
# create_flash_data(
#     BASE_PATH_RGB=path_rgb,
#     BASE_PATH_RESHADE=path_reshade,
#     BASE_TARGET_PATH=path_target,
#     BATCH_SIZE=batch_size,
# )
# print("Shadow")
# create_shadow_data(
#     BASE_PATH_RGB=path_rgb,
#     BASE_PATH_RELIGHTING=path_relighting,
#     BASE_TARGET_PATH=path_target,
# )
